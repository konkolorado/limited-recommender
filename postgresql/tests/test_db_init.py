...
booksfile = os.path.abspath("../../data") + "/BX-Books-Cleansed.csv"
usersfile = os.path.abspath("../../data") + "/BX-Users-Cleansed.csv"
ratingsfile = os.path.abspath("../../data") + "/BX-Book-Ratings-Cleansed.csv"
