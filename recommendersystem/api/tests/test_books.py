...
class BookViewPostTestCase(TestCase):
    ...
    def test_api_can_create_book(self):
        response = self.client.post(
            reverse('api-book-list'), self.book, format="json")
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)

    def test_api_cannot_create_duplicate_book(self):
        self.client.post(reverse('api-book-list'), self.book, format="json")
        response = self.client.post(reverse('api-book-list'),
